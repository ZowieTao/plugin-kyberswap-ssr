...
export function getNFTMetadata(params: components.GetNFTMetadataRequestParams) {
  return client.get<components.GetNFTMetadataResponse>(
    '/tokens/:tokenId',
    params,
  );
}
 ...
 * @param params
 */
export function refreshUserTiers(
  params: components.RefreshUserTiersRequestParams,
) {
  return client.post<components.RefreshUserTiersResponse>(
    '/v1/users/:userId/tiers/refresh',
    params,
  );
}
